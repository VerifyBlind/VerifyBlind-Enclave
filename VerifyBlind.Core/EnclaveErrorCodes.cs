...
public static class EnclaveErrorCodes
{
    ...
    /// <summary>Nonce 15 dk'lık tazelik penceresini aştı — kullanıcı kayıt akışını süresinde
    /// bitiremedi. Beklenen kullanıcı durumu; NonceVerification (imza geçersiz / cihaz saati ileri)
    /// ile AYNI ŞEY DEĞİLDİR ve relay tarafında Sentry'ye event üretmez.</summary>
    public const string NonceExpired          = "ERR_NONCE_EXPIRED";
